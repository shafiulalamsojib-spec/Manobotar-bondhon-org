      ...
      <main className="flex-grow">
        <Routes>
          ...
          <Route 
            ...
            element={user && user.role === 'Member' ? <MemberDashboard user={user} /> : <Navigate to="/login" />} 
          />

          <Route 
            path="/payment-methods" 
            element={user && user.role === 'Member' ? <PaymentMethods user={user} /> : <Navigate to="/login" />} 
          />
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-center md:text-left max-w-4xl mx-auto">
            ...
            <div>
              ...
              <p className="text-emerald-300 text-sm font-bold">তালুক জামিরা, পলাশবাড়ী, গাইবান্ধা</p>
              <p className="text-emerald-300 text-sm mt-1 font-bold">ইমেইল: manobotarbondhon2025@gmail.com</p>
            </div>
          </div>
          <div className="mt-12 pt-8 border-t border-emerald-800 text-center">
            <p className="text-emerald-400 text-sm font-bold">© ২০২৬ মানবতার বন্ধন সামাজিক সংগঠন। সর্বস্বত্ব সংরক্ষিত।</p>
          </div>
        </div>
      </footer>
    </div>
